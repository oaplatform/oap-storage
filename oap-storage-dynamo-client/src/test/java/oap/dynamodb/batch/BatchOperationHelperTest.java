...
import oap.dynamodb.AbstractDynamodbFixture;
import oap.dynamodb.Key;
import oap.dynamodb.TestContainerDynamodbFixture;
...
import oap.dynamodb.crud.ReadItemOperation;
...
public class BatchOperationHelperTest extends Fixtures {
    ...
    public void testBatchOperation() throws Exception {
        ...
        assertThat( client.getRecord( new Key( tableName1, keyName, "id3" ), null ).failureValue ).isEqualTo( NOT_FOUND );
    }
